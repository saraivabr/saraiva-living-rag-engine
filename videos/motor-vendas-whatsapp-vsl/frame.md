...
typography:
  ...
  title-card-sm:{ fontFamily: "Geist", cqw: 2.9, weight: 500, lineHeight: 0.98, tracking: "-0.01em" }
  title-card:{ fontFamily: "Geist", cqw: 3.5, weight: 500, lineHeight: 0.96, tracking: "-0.01em" }
  headline:{ fontFamily: "Geist", cqw: 4.4, weight: 500, lineHeight: 1.0, tracking: "-0.02em" }
  headline-xl:{ fontFamily: "Geist", cqw: 5.0, weight: 500, lineHeight: 0.96, tracking: "-0.02em" }
  display:{ fontFamily: "Geist", cqw: 7.3, weight: 500, lineHeight: 1.02, tracking: "-0.02em" }
  display-hero:{ fontFamily: "Geist", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.02em" }
  stat-figure:{ fontFamily: "Geist", cqw: 11.5, weight: 500, lineHeight: 0.92, tracking: "-0.03em" }
  stat-figure-unit:{ fontFamily: "Geist", cqw: 5.7, weight: 500, lineHeight: 0.92 }
  name:    { fontFamily: "Geist", cqw: 2.3, weight: 700, lineHeight: 1.0 }
...
- **Weights** — the brand font ships `{400, 500, 700, 750, 800, 850, 900}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
